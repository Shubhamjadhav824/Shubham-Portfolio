  ...
  if (contactForm) {
    contactForm.addEventListener('submit', async function(e) {
      ...
      try {
        ...
        const response = await fetch('https://formspree.io/f/xblkwydj', {
          method: 'POST',
          headers: {
...
${data.message}
        ...
        const mailtoLink = `mailto:shubhamjadhav60721@gmail.com?subject=${emailSubject}&body=${emailBody}`;
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const criticalImages = [
    './assets/shubhamportfolioimage.jpg',
    './assets/cursor.png'
  ];
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const endpoints = {
    user: `https://github.com/Shubhamjadhav824${username}`,
    repos: `https://github.com/Shubhamjadhav824?tab=repositories${username}/repos`,
  ...
  async function fetchGitHubData() {
    try {
      ...
      // Show fallback data
      document.getElementById('githubRepos').textContent = '10+';
